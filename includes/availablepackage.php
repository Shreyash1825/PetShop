            	...
            	<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                	<table>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">&emsp; <input type="text" step="any" class="form-control" name="prize" placeholder="0.00" required /></td>
                        </tr>
                        <tr>
...
//
            ...
            $path = "./images/upload/" . $_FILES["image"]["name"];
