...
<head>
    ...
    <title>ADMIN | Pet Equipment Storealasan Quary</title>
  ...
  <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                   ...
                   <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><img src="images/logo.jpg"  width="15% "/> Pet Equipment Store</h4></a>
                </div>
...
<div class="container wow fadeInDown">
    <div class="row">
        ...
        <center><img src="images/b6.jpg" class="img-responsive wow fadeInDown" style="height:200px;" /></center>
        <div>
            <?php
                session_start();
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2020 eazicakes. All Rights Reserved.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
